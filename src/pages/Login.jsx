...
export default function Login() {
  ...
  const handleFacebook = async () => {
    ...
    login({ name: 'Facebook User', email: 'fb@metalead.com', role: 'Admin' })
    navigate('/')
  }
      ...
      >
          ...
          {[...Array(6)].map((_, i) => (
            <motion.div
              ...
              style={{
                ...
                left: `${-60 + i * 30}px`, top: `${-60 + i * 20}px`,
              }}
            />
          ))}
        </div>
        <div className="relative z-10 text-center px-12 max-w-md">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
            Meta Lead<br /><span className="text-primary-400">CRM</span>
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed mb-8">
            Capture, manage, and convert your Meta ad leads with intelligent automation.
          </p>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <motion.button
            ...
            disabled={fbLoading}
            className="w-full flex items-center justify-center gap-3 bg-[#1877F2] hover:bg-[#166FE5] text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/30 mb-6 disabled:opacity-70"
          >
            <FacebookIcon />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin@metalead.com"
